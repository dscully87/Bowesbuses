...
(function () {
  ...
  function seed() {
    return {
      fleet: [
        { id: "bus_1", name: "Mercedes Sprinter", reg: "191-KK-1024", seats: 16, type: "Minibus", status: "active", notes: "Wheelchair accessible lift" },
        { id: "bus_2", name: "Ford Transit", reg: "182-KK-3377", seats: 14, type: "Minibus", status: "active", notes: "" },
        { id: "bus_3", name: "Iveco Daily", reg: "201-KK-8891", seats: 19, type: "Midi bus", status: "active", notes: "Luggage trailer available" },
        { id: "bus_4", name: "Volkswagen Crafter", reg: "172-KK-5560", seats: 12, type: "Minibus", status: "maintenance", notes: "In for service until further notice" }
      ],
      drivers: [
      ...
      bookings: [
        {
          id: "bk_seed1", name: "St. Canice's GAA Club", email: "secretary@example.com", phone: "PLACEHOLDER",
          date: todayISO(2), time: "08:30", pickup: "Kilkenny City", destination: "Croke Park, Dublin",
          passengers: 15, notes: "Return trip, collection after the match.",
        ...
        },
        {
          ...
          date: todayISO(4), time: "13:00", pickup: "Thomastown", destination: "Mount Juliet Estate",
          passengers: 18, notes: "Two runs may be needed.",
        ...
        },
        {
          ...
          date: todayISO(7), time: "10:00", pickup: "Castlecomer", destination: "Waterford Greenway",
          passengers: 12, notes: "",
        ...
        },
        {
          ...
          date: todayISO(-3), time: "09:00", pickup: "Kilkenny City", destination: "Dublin Zoo",
          passengers: 16, notes: "",
          status: "completed", busId: "bus_1", driverId: "drv_2", createdAt: todayISO(-14)
        },
        {
          id: "bk_seed5", name: "Stag Party — Murphy", email: "murphy@example.com", phone: "PLACEHOLDER",
          date: todayISO(-10), time: "18:00", pickup: "Kilkenny City", destination: "Carlow Town",
          passengers: 13, notes: "",
          status: "completed", busId: "bus_2", driverId: "drv_1", createdAt: todayISO(-20)
        },
        {
          id: "bk_seed6", name: "Airport Run — Brennan", email: "brennan@example.com", phone: "PLACEHOLDER",
          date: todayISO(1), time: "04:30", pickup: "Kilkenny City", destination: "Dublin Airport",
          passengers: 8, notes: "Early start.",
          status: "confirmed", busId: "bus_2", driverId: "drv_3", createdAt: todayISO(-2)
        },
        {
          id: "bk_seed7", name: "Hen Party — Doyle", email: "doyle@example.com", phone: "PLACEHOLDER",
          date: todayISO(12), time: "17:00", pickup: "Callan", destination: "Kilkenny City",
          passengers: 14, notes: "",
